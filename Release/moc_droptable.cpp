...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DropTable_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DropTable_t qt_meta_stringdata_DropTable = {
    {
QT_MOC_LITERAL(0, 0, 9), // "DropTable"
QT_MOC_LITERAL(1, 10, 17), // "senddragMoveEvent"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 11), // "QDropEvent*"
QT_MOC_LITERAL(4, 41, 5) // "event"

    },
    "DropTable\0senddragMoveEvent\0\0QDropEvent*\0"
    "event"
};
...
void DropTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DropTable *_t = static_cast<DropTable *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->senddragMoveEvent((*reinterpret_cast< QDropEvent*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (DropTable::*_t)(QDropEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DropTable::senddragMoveEvent)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DropTable::staticMetaObject = {
    { &QTableView::staticMetaObject, qt_meta_stringdata_DropTable.data,
      qt_meta_data_DropTable,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DropTable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DropTable.stringdata0))
        return static_cast<void*>(const_cast< DropTable*>(this));
...
// SIGNAL 0
void DropTable::senddragMoveEvent(QDropEvent * _t1)
{
